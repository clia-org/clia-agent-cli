...
@Metadata {
  ...
  @PageImage(purpose: icon, source: "clia-expertise-icon", alt: "clia-expertise icon")
  @PageImage(purpose: card, source: "clia-expertise-card", alt: "clia-expertise card")
}
...
@Image(source: "clia-expertise-hero", alt: "CLIA Expertise hero")


@Image(source: "hero-expertise-banner", alt: "CLIA expertise banner")
...
@Image(source: "palette-clia", alt: "CLIA palette swatches")
...
@Row {
  @Column {
    @Image(source: "icon-docc-authoring", alt: "DocC authoring icon")
    DocC authoring
  }
  @Column {
    @Image(source: "icon-docc-style-kit", alt: "DocC visual style icon")
    DocC visual style
  }
  @Column {
    @Image(source: "icon-passkit-mirroring", alt: "PassKit mirroring icon")
    PassKit mirroring
  }
}
...
@Row {
  @Column {
    @Image(source: "icon-triads-naming", alt: "Triads and naming icon")
    CLIA triads
  }
  @Column {
    @Image(source: "icon-repo-migrations", alt: "Repo migrations icon")
    Repo migrations
  }
  @Column {
    @Image(source: "icon-tooling-specs", alt: "Tooling and specs icon")
    Tooling and specs
  }
}
...
@Row {
  @Column {
    @Image(source: "icon-templates-motifs", alt: "Templates and motifs icon")
