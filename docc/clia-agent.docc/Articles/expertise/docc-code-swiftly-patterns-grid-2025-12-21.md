...
@Metadata {
  @PageColor(blue)
  @PageImage(purpose: icon, source: "expertise-docc-code-swiftly-patterns-grid-2025-12-21-icon", alt: "expertise-docc-code-swiftly-patterns-grid-2025-12-21 icon")
  @PageImage(purpose: card, source: "expertise-docc-code-swiftly-patterns-grid-2025-12-21-card", alt: "expertise-docc-code-swiftly-patterns-grid-2025-12-21 card")
}

@Image(source: "expertise-docc-code-swiftly-patterns-grid-2025-12-21-hero", alt: "Code-swiftly pattern hub and per-pattern pages hero")
...
```bash
xcrun docc preview \
  /Users/example/workspace/code-swiftly/swift-interview-guide.docc \
