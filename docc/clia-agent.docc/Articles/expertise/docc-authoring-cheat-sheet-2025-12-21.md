...
@Metadata {
  @PageColor(blue)
  @PageImage(purpose: icon, source: "expertise-docc-authoring-cheat-sheet-2025-12-21-icon", alt: "expertise-docc-authoring-cheat-sheet-2025-12-21 icon")
  @PageImage(purpose: card, source: "expertise-docc-authoring-cheat-sheet-2025-12-21-card", alt: "expertise-docc-authoring-cheat-sheet-2025-12-21 card")
}

@Image(source: "expertise-docc-authoring-cheat-sheet-2025-12-21-hero", alt: "DocC authoring cheat sheet hero")
...
- `@Links` list includes tutorials
  ...
  - Solution: keep `doc-ellipsis` links inside `Links` and list tutorials separately.
- Missing assets
  - Problem:
...
- `Links(...) { - doc-ellipsis }` renders link cards anywhere, not only in `## Topics`.
